...
public class ICommentServiceTest {
    ...
    void initTestEnv(){
        ...
        this.frontendComment.setAuthor("TestNName");
    ...
    void findByIdTest(){
        try {
            ...
            assertThat(commentService.findById(this.comment.getId()).getAuthor()).isEqualTo(this.comment.getAuthor());
        }
